...
function renderMiniElement(el: CanvasElement) {
  ...
  if (el.type === "heading") return (
    <div key={el.id} style={{ ...base, fontFamily: "'Bebas Neue', sans-serif", fontSize: Math.max(8, (el.fontSize ?? 36) * scale), color: el.fill, overflow: "hidden", userSelect: "none", display: "flex", alignItems: "center" }}>
      {el.content}
    </div>
  );
  ...
  return (
    <div style={{ height: "100vh", display: "flex", flexDirection: "column", background: "#E8E2D9", overflow: "hidden" }}>
      ...
      <div style={{ background: "#2C2C2C", display: "flex", alignItems: "center", gap: "1rem", padding: "0.6rem 1.25rem", flexShrink: 0, borderBottom: "2px solid #1a1a1a" }}>
        ...
        <div>
          <div style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: "0.12em", fontSize: "0.75rem", color: "#CC2200" }}>
            DISCUSSION PHASE
          </div>
        ...
        <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: "1rem" }}>
          ...
          {amIHost && (
            <button onClick={onSkip} style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: "0.08em", fontSize: "0.85rem", color: "#E8E2D9", background: "rgba(232,226,217,0.08)", border: "1px solid rgba(232,226,217,0.2)", padding: "0.35rem 0.75rem", cursor: "pointer" }}>
              Skip →
            </button>
          )}
        </div>
      ...
      <div style={{ flex: 1, display: "flex", overflow: "hidden" }}>
        ...
        <div style={{ width: "540px", flexShrink: 0, display: "flex", flexDirection: "column", padding: "1.25rem", borderRight: "2px solid rgba(44,44,44,0.15)", gap: "0.75rem" }}>
          <div style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: "0.12em", fontSize: "0.75rem", color: "rgba(44,44,44,0.5)" }}>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
          ...
          <div style={{ flex: 1, overflowY: "auto", padding: "1rem 1.25rem", display: "flex", flexDirection: "column", gap: "0.75rem" }}>
            <div style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: "0.12em", fontSize: "0.75rem", color: "rgba(44,44,44,0.4)", textAlign: "center", paddingBottom: "0.5rem", borderBottom: "1px solid rgba(44,44,44,0.1)" }}>
